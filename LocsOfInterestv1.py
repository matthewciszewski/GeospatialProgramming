...
class LocationsOfInterestv1(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        ...
        'The input is a raw data table in spreadsheet format, as formatted by the supplying financial institute,'
        'and the output is a shape file with indexed scores, closest police station and residential address, if available''\n'
